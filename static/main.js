...
$(document).ready(function(){
    ...
    var fieldHTML = '<div class="form-row"> <div class="col-4"> <input type="text" name="city[]" class="form-control" placeholder="City"> </div> <div class="col-3"> <input type="text" name="city[]" class="form-control" placeholder="Days"> </div> <div class="col-2"> <button type="button" class="btn btn-danger remove">X</button> </div> </div> '; //New input field html
